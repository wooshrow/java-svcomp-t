...
public class Main {
  public static void main(String[] args) {
    ...
    while (Verifier.nondetBoolean()) {
      // outer: advance 'a' once per cycle
      a = a + 1.0;

      // inner: allow at most one catch-up step for 'b' (still nested)
      int t = 0;
      while (t < 1 && b < a) {
        b = b + 1.0;
        t = t + 1;
      ...
      // joint reset keeps both inside a small box
      if (a > 10.0) {
        a = 0.0;
        b = 0.0;
      }
