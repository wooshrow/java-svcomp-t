...
public class Main {
  public static void main(String[] args) {
    ...
    String input_1_3 = Verifier.nondetString();
    Integer input_1_4 = Verifier.nondetInt();
    Integer input_1_5 = Verifier.nondetInt();
    String input_2_0 = Verifier.nondetString();
    Boolean input_2_1 = Verifier.nondetBoolean();
    Integer input_2_2 = Verifier.nondetInt();
    String input_2_3 = Verifier.nondetString();
    Integer input_2_4 = Verifier.nondetInt();
    Integer input_2_5 = Verifier.nondetInt();

    // Perform computation
    Boolean output_1 =
        input_1_0.regionMatches(input_1_1, input_1_2, input_1_3, input_1_4, input_1_5);
    Boolean output_2 =
        input_2_0.regionMatches(input_2_1, input_2_2, input_2_3, input_2_4, input_2_5);
