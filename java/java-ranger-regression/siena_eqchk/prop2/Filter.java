...
public class Filter {
  ...
  /**
   * put a constraint on attribute <em>name</em> using comparison operator <em>op</em> and a <code>
   * String</code> argument <em>sval</em>.
   *
   * <pre><code>
   * Filter f = new Filter();
  ...
  /**
   * put a constraint on attribute <em>name</em> using comparison operator <em>op</em> and an <code>
   * int</code> argument <em>ival</em>.
   *
   * <pre><code>
   * Filter f = new Filter();
  ...
  /**
   * put a constraint on attribute <em>name</em> using comparison operator <em>op</em> and a <code>
   * boolean</code> argument <em>bval</em>.
   *
   * <pre><code>
   * Filter f = new Filter();
  ...
  /**
   * put a constraint on attribute <em>name</em> using comparison operator <em>op</em> and a <code>
   * double</code> argument <em>dval</em>.
   */
  ...
  /**
   * put a constraint on attribute <em>name</em> using the equality operator and a <code>String
   * </code> argument <em>sval</em>. Example:
   *
   * <pre><code>
   * Filter f = new Filter();
  ...
  /**
   * put a constraint on attribute <em>name</em> using the equality operator and a <code>byte[]
  ...
  /**
   * put a constraint on attribute <em>name</em> using the equality operator and a <code>int</code>
   * argument <em>ival</em>.
   */
  ...
  /**
   * put a constraint on attribute <em>name</em> using the equality operator and a <code>boolean
  ...
  /**
   * put a constraint on attribute <em>name</em> using the equality operator and a <code>long</code>
   * argument <em>lval</em>.
   */
  ...
  /**
   * put a constraint on attribute <em>name</em> using the equality operator and a <code>double
  ...
  /**
   * returns an iterator for the set of attribute (constraint) names of this <code>Filter</code>.
   */
  ...
  /**
   * returns an iterator for the set of constraints over attribute <em>name</em> of this <code>
   * Filter</code>.
   */
